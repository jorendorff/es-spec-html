...
var legacy_sections = {
    ...
    "sec-additions-and-changes-that-introduce-incompatibilities-with-prior-editions": "sec-D-additions-and-changes-that-introduce-incompatibilities-with-prior-editions",
    ...
    "sec-corrections-and-clarifications-with-possible-compatibility-impact": "sec-D-additions-and-changes-that-introduce-incompatibilities-with-prior-editions",
    ...
    "sec-in-the-5th-edition": "sec-D-additions-and-changes-that-introduce-incompatibilities-with-prior-editions-in-the-5th-edition",
    "sec-in-the-6th-edition": "sec-D-additions-and-changes-that-introduce-incompatibilities-with-prior-editions-in-the-6th-edition",
    ...
    "sec-promiseall-promiselist-abstaction-operation": "sec-promiseall-promiselist-abstact-operation",
    "sec-promisebuiltincapability-abstaction-operation": "sec-promisebuiltincapability-abstact-operation",
    "sec-promisecatch-promise-rejectedaction-abstaction-operation": "sec-promisecatch-promise-rejectedaction-abstact-operation",
    "sec-promisenew-executor-abstaction-operation": "sec-promisenew-executor-abstact-operation",
    "sec-promiseof-value-abstaction-operation": "sec-promiseof-value-abstact-operation",
    "sec-promisethen-promise-resolvedaction-rejectedaction-abstaction-operation": "sec-promisethen-promise-resolvedaction-rejectedaction-abstact-operation",
